...
// Submit Data
		if (isset($_POST['Submit_save']) || isset($_POST['Submit_approve'])) {
			...
			if (trim($_POST['user']['phone']) == "") {$error .= "Please enter Telephone - Primary<br />";} else {
				if (trim($_POST['user']['phone']) == trim($_POST['user']['mobile'])) {$error .= "Telephone - Primary and Alternate can not have the same Telephone number<br />";}
			}

			//	Comment Validation
			$tmp_array2 = array();
			$tmp_array = array("61" => "address", "79" => "ref_address_1", "89" => "ref_address_2", "83" => "ref_phone_1", "93" => "ref_phone_2", "84" => "ref_email_1", "94" => "ref_email_2");
			foreach ($_POST['intake_comment_result'] as $intake_comment_id => $intake_comment_body) {
				$icrR = $this->default_model->getRowArray("SELECT * FROM intake_comment_result where client_id='$client_id' and intake_comment_id='$intake_comment_id' limit 1");
				$iqR = $this->default_model->getRowArray("SELECT * FROM intake_question where intake_question_id='" . $icrR['intake_question_id'] . "' limit 1");
				$intake_question_id = $iqR['intake_question_id'];
				if (isset($tmp_array[$intake_question_id])) {
					$tv = $tmp_array[$intake_question_id];
					$tmp_array2[$tv] = $intake_comment_body;}

				if ($iqR['question_required'] == "Yes") {
					if ($intake_question_id == "59") {
						$ssncheck = preg_match($ssn_validation_regex, $intake_comment_body); // returns 1
						if ($ssncheck != '1') {$error .= "Please enter valid <em>" . $iqR['intake_question_body'] . "</em>" . "<br />";}
					} else {if (trim($intake_comment_body) == "") {$error .= "Please enter " . $iqR['intake_question_body'] . "<br />";}}
				}
			}
			...
			if ($error == "") {
				// Set Phone Number and Mobile Number
				$this->db->query("UPDATE users set phone='" . $_POST['user']['phone'] . "', mobile='" . $_POST['user']['mobile'] . "' where id='$client_id'");
				//	Set Intake Input Answer
				foreach ($_POST['intake_comment_result'] as $intake_comment_id => $intake_comment_body) {
					$this->db->query("UPDATE intake_comment_result set intake_comment_body='$intake_comment_body' where client_id='$client_id' and intake_comment_id='$intake_comment_id'");
				}

				//	Set Intake Input Answer
				foreach ($_POST['intake_answer_result'] as $intake_result_id => $intake_answer_id) {
					$this->db->query("UPDATE intake_answer_result set intake_answer_id='$intake_answer_id' where client_id='$client_id' and intake_result_id='$intake_result_id'");
				}

				unset($_POST['user']);
				unset($_POST['intake_comment_result']);
				unset($_POST['intake_answer_result']);
...
.input_4 {width:100%; height:16px; padding:2px 2px 1px 2px; background:transparent; font-size:11px; border:none; border-bottom:1px solid #000000;}
...
<div class="row">
	<div class="col-md-7">
    	<h3 style="margin:5px 0 0 0px;"><strong>Data Confirmation - <?php echo str_replace("Intake", "", $intkR['intake_title']); ?> <!--for the <?php //echo $intkR['intake_title']; ?>--></strong></h3>
...
<!--<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Last Name: </label> <input type="text" class="form-control" value="<?php echo $user['lname']; ?>" readonly required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">First Name: </label> <input type="text" class="form-control" value="<?php echo $user['name']; ?>" readonly required /></div></div>-->

<div class="col-md-3"><div class="mb-3 mt-3"><label for="email" class="form-label">Middle Initial: </label> <input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[1]['intake_comment_id']; ?>]" value="<?php echo $ansR[1]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-3"><div class="mb-3 mt-3"><label for="email" class="form-label">Former Name(s):</label> <input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[2]['intake_comment_id']; ?>]" value="<?php echo $ansR[2]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-3"><div class="mb-3 mt-3"><label for="email" class="form-label">SSN:</label> <input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[3]['intake_comment_id']; ?>]" value="<?php echo $ansR[3]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-3"><div class="mb-3 mt-3"><label for="email" class="form-label">Date of Birth:</label> <input type="date" class="form-control" name="intake_comment_result[<?php echo $ansR[4]['intake_comment_id']; ?>]" value="<?php echo $ansR[4]['intake_comment_body']; ?>" required /></div></div>
...
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[5]['intake_comment_id']; ?>]" value="<?php echo $ansR[5]['intake_comment_body']; ?>" required /></div></div>


<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">City:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[6]['intake_comment_id']; ?>]" value="<?php echo $ansR[6]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">State:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[7]['intake_comment_id']; ?>]" value="<?php echo $ansR[7]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Zip Code:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[8]['intake_comment_id']; ?>]" value="<?php echo $ansR[8]['intake_comment_body']; ?>" required /></div></div>


<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Telephone - Primary:</label>
<input type="text" class="form-control" name="user[phone]" value="<?php echo trim($user['phone']); ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Telephone - Alternate:</label>
<input type="text" class="form-control" name="user[mobile]" value="<?php echo trim($user['mobile']); ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Email (Optional):</label>
<input type="email" class="form-control" name="intake_comment_result[<?php echo $ansR[9]['intake_comment_id']; ?>]" value="<?php echo $ansR[10]['intake_comment_body']; ?>" /></div></div>
<div class="clr"></div>


<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Driver’s License State:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[11]['intake_comment_id']; ?>]" value="<?php echo $ansR[11]['intake_comment_body']; ?>" required /></div></div>


<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Driver’s License Number:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[12]['intake_comment_id']; ?>]" value="<?php echo $ansR[12]['intake_comment_body']; ?>" required /></div></div>
...
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[14]['intake_comment_id']; ?>]" value="<?php echo $ansR[14]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Employer Street:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[15]['intake_comment_id']; ?>]" value="<?php echo $ansR[15]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Employer City:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[16]['intake_comment_id']; ?>]" value="<?php echo $ansR[16]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Employer State:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[17]['intake_comment_id']; ?>]" value="<?php echo $ansR[17]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Employer Zip Code:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[18]['intake_comment_id']; ?>]" value="<?php echo $ansR[18]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Employer Phone Number:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[19]['intake_comment_id']; ?>]" value="<?php echo $ansR[19]['intake_comment_body']; ?>" /></div></div>
...
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[20]['intake_comment_id']; ?>]" value="<?php echo $ansR[20]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 middle initial:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[21]['intake_comment_id']; ?>]" value="<?php echo $ansR[21]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 last name:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[22]['intake_comment_id']; ?>]" value="<?php echo $ansR[22]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 Street:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[23]['intake_comment_id']; ?>]" value="<?php echo $ansR[23]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 City:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[24]['intake_comment_id']; ?>]" value="<?php echo $ansR[24]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 State:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[25]['intake_comment_id']; ?>]" value="<?php echo $ansR[25]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 Zip Code:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[26]['intake_comment_id']; ?>]" value="<?php echo $ansR[26]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 Phone Number:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[27]['intake_comment_id']; ?>]" value="<?php echo $ansR[27]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 e-mail:</label>
<input type="email" class="form-control" name="intake_comment_result[<?php echo $ansR[28]['intake_comment_id']; ?>]" value="<?php echo $ansR[28]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 1 Relationship to you:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[29]['intake_comment_id']; ?>]" value="<?php echo $ansR[29]['intake_comment_body']; ?>" required /></div></div>

<div class="clr mb_20"></div>


<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 first name:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[30]['intake_comment_id']; ?>]" value="<?php echo $ansR[30]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 middle initial:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[31]['intake_comment_id']; ?>]" value="<?php echo $ansR[31]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 last name:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[32]['intake_comment_id']; ?>]" value="<?php echo $ansR[32]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 Street:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[33]['intake_comment_id']; ?>]" value="<?php echo $ansR[33]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 City:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[34]['intake_comment_id']; ?>]" value="<?php echo $ansR[34]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 State:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[35]['intake_comment_id']; ?>]" value="<?php echo $ansR[35]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 Zip Code:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[36]['intake_comment_id']; ?>]" value="<?php echo $ansR[36]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 Phone Number:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[37]['intake_comment_id']; ?>]" value="<?php echo $ansR[37]['intake_comment_body']; ?>" required /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 e-mail:</label>
<input type="email" class="form-control" name="intake_comment_result[<?php echo $ansR[38]['intake_comment_id']; ?>]" value="<?php echo $ansR[38]['intake_comment_body']; ?>" /></div></div>

<div class="col-md-4"><div class="mb-3 mt-3"><label for="email" class="form-label">Reference 2 Relationship to you:</label>
<input type="text" class="form-control" name="intake_comment_result[<?php echo $ansR[39]['intake_comment_id']; ?>]" value="<?php echo $ansR[39]['intake_comment_body']; ?>" required /></div></div>
...
<div>
<?php
//$tmp_arr_40 = array("60"=>"Mohela – Must choose for PSLF", "67"=>"Nelnet", "68"=>"Great Lakes", "69"=>"HESC/Ed Financial", "70"=>"OSLA Servicing", "71"=>"Aidvantage");
			$tmp_arr_40 = array("66" => "Mohela – Must choose for PSLF", "67" => "Nelnet", "69" => "HESC/Ed Financial", "71" => "Aidvantage");
			foreach ($tmp_arr_40 as $k => $v) {
				?>
<label class="radio-inline"><input type="radio" name="intake_answer_result[<?php echo $ansR[40]['intake_result_id']; ?>]" value="<?php echo $k; ?>" <?php if ($ansR[40]['intake_answer_id'] == $k) {echo " checked";}?> required="required"> <?php echo $v; ?></label> &nbsp; <?php }?>
...
<div class="col-md-6" id="div_radio_2"><div class="mb-3 mt-3"><label for="email" class="form-label">2. Choose a plan and then continue to Item 3.</label>
...
<div class="col-md-6"><div class="mb-3 mt-3"><label for="email" class="form-label">5. How many children, including unborn children, are in your family and receive more than half of their support from you?</label><input type="text" class="form-control" value="<?php echo $ansintkR['19']['intake_comment_body']; ?>" /></div></div>


<div class="col-md-6"><div class="mb-3 mt-3"><label for="email" class="form-label">6. How many other people, excluding your spouse and children, live with you and receive more than half of their support from you?</label><input type="text" class="form-control" value="<?php echo $ansintkR['20']['intake_comment_body']; ?>" /></div></div>
...
<div class="col-md-6" id="div_radio_8"><div class="mb-3 mt-3"><label for="email" class="form-label">8. Does your spouse have federal student loans?</label>
...
<div class="col-md-6" id="div_radio_9"><div class="mb-3 mt-3"><label for="email" class="form-label">9. Provide the following information about your spouse and then continue to Item 10:</label>

	<div class="mb-3 mt-3"><label for="email" class="form-label">a. Spouse's SSN</label><input type="text" class="form-control" <?php if ($radio[8] == "1") {echo ' name="inputr[user][spouse_ssn]"';} else {echo 'disabled';}?> value="<?php echo $fd['spouse_ssn']; ?>" /></div>

        <div class="mb-3 mt-3"><label for="email" class="form-label">b. Spouse's Name</label><input type="text" class="form-control" <?php if ($radio[8] == "1") {echo ' name="inputr[user][spouse_name]"';} else {echo 'disabled';}?> value="<?php echo $fd['spouse_name']; ?>" /></div>

        <div class="mb-3 mt-3"><label for="email" class="form-label">c. Spouse's Date of Birth</label><input type="date" class="form-control" <?php if ($radio[8] == "1") {echo ' name="inputr[user][spouse_dob]"';} else {echo 'disabled';}?> value="<?php echo $fd['spouse_dob']; ?>" /></div>
</div></div>


<div class="col-md-6" id="div_radio_10"><div class="mb-3 mt-3"><label for="email" class="form-label">10. When you filed your last federal income tax return, did you file jointly with your spouse?</label>
...
<div class="col-md-6" id="div_radio_12"><div class="mb-3 mt-3"><label for="email" class="form-label">12. Do you currently have taxable income?<br />Check "No" if you do not have any income or receive only untaxed income.</label>
...
<div class="col-md-6" id="div_radio_13"><div class="mb-3 mt-3"><label for="email" class="form-label">13. Has your income significantly decreased since you filed your last federal income tax return?<br />For example, have you lost your job or experienced a drop in income?</label>
...
<div class="col-md-6" id="div_radio_14"><div class="mb-3 mt-3"><label for="email" class="form-label">14. Has your spouse's income significantly decreased since your spouse filed his or her last federal income tax return?<br />For example, has your spouse lost his or her job or experienced a drop in income?</label>
...
<div class="col-md-6" id="div_radio_15"><div class="mb-3 mt-3"><label for="email" class="form-label">15. Do you currently have taxable income?<br /> Check "No" if you do not have any income or receive only untaxed income.</label>
...
<div class="col-md-6" id="div_radio_16"><div class="mb-3 mt-3"><label for="email" class="form-label">16. Does your spouse currently have taxable income?<br />Check "No" if your spouse does not have any income or receives only untaxed income.</label>
