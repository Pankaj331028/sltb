...
if ($client_id != '') {
	if (isset($docr['document_id'])) {
		if (isset($ics['id'])) {
			...
			$ansR['dl_state_and_number'] = $ansR[12]['intake_comment_body'] . " " . $ansR[11]['intake_comment_body'];
...
<tr><td>
<table width="100%" border="0" class="pagging_text"><tr><td><span class="pagging_text_font_2">S</span>UBMIT PAGES 1 THROUGH 5<br /><span class="pagging_text_font_2">P</span>AGE <strong>1</strong> OF <strong style="position: absolute;left: 54%;">16</strong> </td></tr></table>
...
<td align="left" style="vertical-align:middle; padding:17px;"><div style="background:transparent; width:55px; height:16px; margin:0 auto; padding:2px 1px;"><?php echo $loan_code_arr[$loan_type]; ?></div></td>
<td style="padding:2px 4px;"><div style="background:transparent; width:98%; height:50px; margin:0 auto;"><?php echo $lrow['loan_contact_name'] . "<br />" . $lrow['loan_contact_street_address_1'] . " " . $lrow['loan_contact_street_address_1'] . " " . $lrow['loan_contact_city'] . " " . $lrow['loan_contact_state'] . " " . $lrow['loan_contact_zip_code']; ?></div></td>
<td style="padding:2px 4px;"><div style="background:transparent; width:98%; height:50px; margin:0 auto;"></div></td>
<td style="padding:2px 4px;"><div style="background:transparent; width:98%; height:20px; margin:0 auto; padding:15px 1px;"><?php echo $fmt->formatCurrency(($lrow['loan_outstanding_principal_balance'] + $lrow['loan_outstanding_interest_balance']), "USD"); ?></div></td>
</tr>
<?php }?>
...
<tr class="style_1" style="font-size:6.5pt; vertical-align:top;">
<td align="left" style="vertical-align:middle; padding:17px;"><div style="background:transparent; width:55px; height:20px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:4px;"><div style="background:transparent; width:98%; height:48px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:4px;"><div style="background:transparent; width:98%; height:48px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:4px;"><div style="background:transparent; width:98%; height:48px; margin:0 auto;">&nbsp;</div></td>
</tr>
<?php }?>
...
<?php for ($i = 0; $i < 4; $i++) {?>
<tr class="style_1" style="font-size:6.5pt; vertical-align:top;">
<td align="left" style="vertical-align:middle; padding:13px;"><div style="background:transparent; width:50px; height:20px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:3px;"><div style="background:transparent; width:98%; height:40px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:3px;"><div style="background:transparent; width:98%; height:40px; margin:0 auto;">&nbsp;</div></td>
<td style="padding:3px;"><div style="background:transparent; width:98%; height:40px; margin:0 auto;">&nbsp;</div></td>
</tr>
<?php }?>
...
<li style="height:45px;">Consolidating a defaulted Federal Consolidation Loan, and I agree to repay my new Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan;</li>
...
<li style="height:45px;">The number of years of qualifying repayment required for loan forgiveness under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan (see BRR Item 11), or</li>
<li>The 120 qualifying payments required for Public Service Loan Forgiveness (see BRR Item 16).</li>
</ul>
<div class="clr mb_10"></div>

<strong>K.</strong> If I am consolidating a Direct PLUS Loan or a Federal PLUS Loan (a Federal PLUS Loan is a PLUS loan made under the Federal Family Education Loan Program) that I obtained to help pay for my child's undergraduate education, I am not eligible to repay my Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, or the IBR Plan. However, I may repay my Direct Consolidation Loan under the ICR Plan.
<div class="clr mb_7"></div>
...
<strong>E.</strong> If I am in default on any loan I am consolidating, I have either made a satisfactory repayment arrangement with the holder of that defaulted loan, or I will repay my Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan, except that I <strong>MUST</strong> repay my Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan under the conditions described above in the Repayment Plan Selection section of this Note.
<div class="clr mb_7"></div>
...
<td><input type="text" class="input_4" name="date" value="" style="width:100px;" />
</tr></table>
...
<li>You agree to repay your Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan (see BRR Item 11).</li>
</ul>
<div class="clr mb_5"></div>
...
<li style="height:30px;">Consolidating a delinquent Federal Consolidation Loan that the lender has submitted to the guaranty agency for default aversion;</li>
<li style="height:45px;">Consolidating a defaulted Federal Consolidation Loan, and you agree to repay your new Direct Consolidation Loan under the SAVE Plan, the PAYE Plan, the IBR Plan, or the ICR Plan;</li>
...
<li style="height:30px;">During some periods of repayment under the SAVE, PAYE, and IBR plans; and</li>
...
<li>During some periods of repayment under the SAVE Plan;</li>
</ul>
</td>
</tr>
</table>
...
<strong>Revised Pay As You Earn Repayment Plan (SAVE Plan)</strong>
<div class="clr mb_7"></div>

The SAVE Plan is available only for Direct Consolidation Loans that did not repay any parent PLUS loans.
<div class="clr mb_7"></div>

Under the SAVE Plan, your monthly payment amount is generally 10% of your discretionary income.
<div class="clr mb_7"></div>

If you are married, the income used to determine your SAVE Plan
...
Under the SAVE Plan, any remaining loan amount will be forgiven after
...
consecutive. Qualifying repayment plans include the SAVE Plan, the PAYE
...
forgiveness under this program you must enter the SAVE Plan, the PAYE
...
<tr><td>
<table width="100%" border="0" class="pagging_text"><tr><td><span class="pagging_text_font_2">S</span>UBMIT PAGES 1 THROUGH 5<br /><span class="pagging_text_font_2">P</span>AGE 16 OF <strong>16</strong> </td></tr></table>
<table width="100%" class="pagging_text_1"><tr><td align="right">12/2019</td></tr></table>
<div class="clr"></div>
...
<?php
// loan_type like '%CONSOLIDA%' and
					for ($ia = 0; $ia <= 4; $ia++) {
						$limit_start = (9 + ($ia * 4));
						$limit = "$limit_start,4";
						$lrows = $this->default_model->get_arrby_tbl('nslds_loans', '*', "client_id='" . $client_id . "' and  (loan_outstanding_principal_balance>'0' or loan_outstanding_interest_balance>'0') order by loan_date desc", $limit);
