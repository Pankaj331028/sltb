...
<?php
$sno = 0;
$sql = "SELECT users_company.name as cname, users_company.slug as slug, users.* FROM users INNER JOIN users_company ON (users.role='Customer') and users.company_id=users_company.id order by users.id desc limit 1000000";
