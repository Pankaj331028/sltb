...
function CheckAuthentication()
{
	...
	class db {
function db(){
		$database="netcsit_netclimber";
		$host="mysql4.netctech.com";
		$userid="netcsit_netclim";
		$password="netc1q2w3e4r";
		define('SITE_ROOT','http://netcsites.com/netclimber');
	mysqli_connect($host,$userid,$password);
